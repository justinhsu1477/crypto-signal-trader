...
public class MartingaleStrategyConfig {
    ...
    public MartingaleStrategyConfig(
            @DefaultValue("4") int maxLayers,
            @DefaultValue("0.012") double stepPercent,
            @DefaultValue("100") double baseSize,
            @DefaultValue("1.4") double sizeMultiplier,
            @DefaultValue("0.015") double takeProfitPercent,
            @DefaultValue("0.30") double maxCapitalUsage,
            @DefaultValue("10000") double maxPositionSize,
            @DefaultValue("0.055") double stopLossPercent,
            ...
            @DefaultValue("0.012") double breakevenTriggerPercent,
            @DefaultValue("0.004") double breakevenOffsetPercent,
            @DefaultValue("14") int atrPeriod,
            @DefaultValue("0.012") double atrReferencePercent,
            ...
            @DefaultValue("0.004") double tpDecayFloorPercent,
